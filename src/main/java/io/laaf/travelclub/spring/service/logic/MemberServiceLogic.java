...
import io.laaf.travelclub.spring.store.MemberStore;
import io.laaf.travelclub.spring.util.exception.MemberDuplicationException;
import io.laaf.travelclub.spring.util.exception.NoSuchMemberException;
...
public class MemberServiceLogic implements MemberService {
    ...
    public String registerMember(MemberCdo member) {
        ...
        CommunityMember foundedMember = memberStore.retrieve(email);
